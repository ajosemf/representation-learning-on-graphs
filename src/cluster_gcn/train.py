...
# by Augusto Jose
flags.DEFINE_integer('model_idx', -1, 'Model params id')
# end by
#########################
...
def main(unused_argv):
  ...
  for epoch in range(FLAGS.epochs):
    ...
    # by Augusto Jose
    time_per_epoch.append(time.time() - t)
  ...
  # by Augusto Jose
  # desabilitado para processar o mprof
  # metrics = [train_loss, cost_val, time_per_epoch, micro, macro]
  # result_file_name = 'results/{}/metrics_{}'.format(FLAGS.dataset, FLAGS.model_idx)
  # np.save(result_file_name, metrics)
  # end by
  ###################################
  ...
  # by Augusto Jose
  save_path = 'model/{}/{}/{}'.format(FLAGS.dataset, FLAGS.model_idx, FLAGS.save_name)
  ...
  with tf.device('/cpu:0'):
    ...
    # by Augusto Jose
    saver.restore(sess_cpu, save_path)
    # end by
    ######################
    # Testing
